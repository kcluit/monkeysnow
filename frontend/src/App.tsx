...
function App(): JSX.Element {
    ...
    return (
        <div className="min-h-screen bg-theme-background transition-colors duration-300 overflow-x-hidden">
            ...
            {/* Footer */}
            <footer className="fixed bottom-2 left-4 text-xs text-theme-textSecondary opacity-40 hover:opacity-100 transition-opacity z-10 flex items-center gap-3">
                <a
                ...
                <span className="hover:text-theme-textPrimary transition-colors cursor-pointer">terms</span>
                <span className="hover:text-theme-textPrimary transition-colors cursor-pointer">privacy</span>
                <button
                    onClick={() => commandPalette.openToCommand('theme')}
                    className="hover:text-theme-textPrimary transition-colors cursor-pointer"
                >
