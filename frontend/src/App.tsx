    ...
    return (
        <div className="min-h-screen bg-theme-background transition-colors duration-300 overflow-x-hidden">
            ...
            <footer className="fixed bottom-2 left-0 right-0 px-4 text-xs text-theme-textSecondary z-10 flex items-center justify-evenly">
                ...
                <span className="flex items-center gap-1.5 opacity-40 hover:opacity-100 hover:text-theme-textPrimary transition-all cursor-pointer">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
                    terms
                </span>
                <span className="flex items-center gap-1.5 hover:text-theme-textPrimary transition-colors cursor-pointer">
