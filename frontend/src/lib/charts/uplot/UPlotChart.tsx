...
import { buildUPlotOptions } from './options';
import { buildUPlotData } from './data';
...
/**
 * Memoized uPlot chart to prevent unnecessary re-renders.
 */
export const UPlotChart = memo(UPlotChartInner);
