...
export const VARIABLE_CONFIGS: Map<WeatherVariable, VariableConfig> = new Map([
  ...
  ['precipitation_probability', {
    ...
    formatValue: (v) => `${Math.round(v)}%`,
    yAxisDomain: [0, 100],
    description: 'Probability of precipitation with more than 0.1 mm',
  }],
  ['showers', {
    id: 'showers',
    label: 'Showers',
  ...
  ['shortwave_radiation', {
    ...
    yAxisDomain: [0, 'auto'],
    description: 'Total global horizontal solar irradiation',
  }],
  ['direct_radiation', {
    id: 'direct_radiation',
    ...
    formatValue: (v) => `${Math.round(v)}W/m²`,
    yAxisDomain: [0, 'auto'],
    description: 'Direct solar radiation on the horizontal plane',
  }],
  ['diffuse_radiation', {
  ...
  ['terrestrial_radiation', {
    ...
    formatValue: (v) => `${Math.round(v)}W/m²`,
    yAxisDomain: [0, 'auto'],
    description: 'Longwave radiation emitted by Earth surface',
  }],
  ['uv_index', {
    id: 'uv_index',
    label: 'UV Index',
  ...
  ['et0_fao_evapotranspiration', {
    ...
    convertToImperial: mmToInches,
    yAxisDomain: [0, 'auto'],
    description: 'ET₀ reference for well-watered grass (FAO-56)',
  }],
  ['cape', {
    id: 'cape',
    label: 'CAPE',
  ...
  // Wind direction overlay levels
  ['wind_direction_80m', {
    id: 'wind_direction_80m',
  ...
  ['wind_direction_120m', {
    id: 'wind_direction_120m',
    label: 'Wind Direction (120m)',
    unit: '',
    unitImperial: '',
    color: '#22c55e',
    chartType: 'line',
  ...
  ['wind_direction_180m', {
    id: 'wind_direction_180m',
    label: 'Wind Direction (180m)',
    unit: '',
    unitImperial: '',
    color: '#16a34a',
    chartType: 'line',
  ...
  // Soil temperature overlay levels
  ['soil_temperature_6cm', {
    ...
    formatValue: (v, u) => u === 'metric' ? `${Math.round(v)}C` : `${Math.round(tempToImperial(v))}F`,
    convertToImperial: tempToImperial,
    description: 'Temperature at 6cm soil depth',
  }],
  ['soil_temperature_18cm', {
    ...
    formatValue: (v, u) => u === 'metric' ? `${Math.round(v)}C` : `${Math.round(tempToImperial(v))}F`,
    convertToImperial: tempToImperial,
    description: 'Temperature at 18cm soil depth',
  }],
  ['soil_temperature_54cm', {
    id: 'soil_temperature_54cm',
    label: 'Soil Temp (54cm)',
    unit: 'C',
    unitImperial: 'F',
    color: '#854d0e',
    chartType: 'line',
    formatValue: (v, u) => u === 'metric' ? `${Math.round(v)}C` : `${Math.round(tempToImperial(v))}F`,
    convertToImperial: tempToImperial,
    description: 'Temperature at 54cm soil depth',
  }],
  // Soil moisture overlay levels
  ['soil_moisture_1_to_3cm', {
    id: 'soil_moisture_1_to_3cm',
    label: 'Soil Moisture (1-3cm)',
    unit: 'm³/m³',
    unitImperial: 'm³/m³',
    color: '#a16207',
    chartType: 'area',
    formatValue: (v) => `${v.toFixed(3)}`,
    yAxisDomain: [0, 1],
    description: 'Average soil water content at 1-3cm depth',
  }],
  ['soil_moisture_3_to_9cm', {
    ...
    formatValue: (v) => `${v.toFixed(3)}`,
    yAxisDomain: [0, 1],
    description: 'Average soil water content at 3-9cm depth',
  }],
  ['soil_moisture_9_to_27cm', {
    id: 'soil_moisture_9_to_27cm',
    label: 'Soil Moisture (9-27cm)',
    unit: 'm³/m³',
    unitImperial: 'm³/m³',
    color: '#78350f',
    chartType: 'area',
    formatValue: (v) => `${v.toFixed(3)}`,
    yAxisDomain: [0, 1],
    description: 'Average soil water content at 9-27cm depth',
  }],
  ['soil_moisture_27_to_81cm', {
    id: 'soil_moisture_27_to_81cm',
    label: 'Soil Moisture (27-81cm)',
    unit: 'm³/m³',
    unitImperial: 'm³/m³',
    color: '#713f12',
    chartType: 'area',
    formatValue: (v) => `${v.toFixed(3)}`,
    yAxisDomain: [0, 1],
    description: 'Average soil water content at 27-81cm depth',
  }],
]);
