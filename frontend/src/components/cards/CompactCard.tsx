    ...
    return (
        <div className="resort-card rounded-xl p-3 shadow-md backdrop-blur-md">
            ...
            <div className="relative">
                <button
                    onClick={scrollLeft}
                    className="absolute left-0 top-1/2 -translate-y-1/2 -ml-2 z-10 bg-theme-cardBg rounded-full p-1 shadow-md hover:bg-theme-secondary transition-all text-theme-textPrimary opacity-70 hover:opacity-100"
                >
                ...
                <button
                    onClick={scrollRight}
                    className="absolute right-0 top-1/2 -translate-y-1/2 -mr-2 z-10 bg-theme-cardBg rounded-full p-1 shadow-md hover:bg-theme-secondary transition-all text-theme-textPrimary opacity-70 hover:opacity-100"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2.5" stroke="currentColor" className="w-3 h-3">
